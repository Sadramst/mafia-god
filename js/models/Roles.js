...
export class Roles {
  ...
  static ALL = {
    ...
    jack: {
      ...
      team: 'independent',
      icon: '🔪',
      description: 'قاتل سریالی مستقل. هر شب یک نفر را می‌کشد. با شلیک مافیا کشته نمی‌شود اما با سلاخی قابل حذف است.',
    ...
    zodiac: {
      ...
      team: 'independent',
      icon: '♈',
      description: 'قاتل مستقل. هر شب می‌تواند یک نفر را بکشد. با شلیک مافیا کشته نمی‌شود اما با سلاخی قابل حذف است.',
      nightAction: 'soloKill',
      nightOrder: 21,
      maxCount: 1,
      unique: true,
