...
export class Roles {
  ...
  static ALL = {
    ...
    jadoogar: {
      ...
      team: 'mafia',
      icon: '🧙',
      description: 'هر شب بیدار می‌شود و اقدام شبانه یک شهروند یا مستقل را خنثی می‌کند. آن بازیکن آن شب نمی‌تواند کاری انجام دهد. اگر آن بازیکن تیر (مشقی یا جنگی) از تفنگدار داشته باشد، می‌تواند شلیک کند ولی تیرش هر چه باشد مشقی حساب می‌شود.',
      nightAction: 'block',
      nightOrder: 6,
      maxCount: 1,
      unique: true,
