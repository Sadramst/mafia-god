...
export class Roles {
  ...
  static ALL = {
    ...
    zodiac: {
      ...
      team: 'independent',
      icon: '♈',
      description: 'قاتل مستقل. شلیک دارد (هر شب، شب‌های فرد یا زوج بر اساس تنظیمات). با شلیک شبانه کشته نمی‌شود. اگر به فردی که محافظ دارد شلیک کند، زودیاک حذف می‌شود و محافظ می‌ماند. با رأی روز قابل حذف است.',
