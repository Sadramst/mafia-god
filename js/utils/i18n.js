...
export const translations = {
  ...
  day: {
    ...
    positive: { fa: 'مثبت (مافیا)', en: 'Positive (Mafia)' },
    negative: { fa: 'منفی (غیر مافیا)', en: 'Negative (Not Mafia)' },
    blocked: { fa: 'بلاک شده توسط جادوگر', en: 'Blocked by Sorcerer' },
    bombed: { fa: 'بمب روی', en: 'Bomb on' },
    blockAction: { fa: 'اقدام خنثی‌شده', en: 'Action Blocked' },
    jackCurse: { fa: 'طلسم جک روی', en: 'Jack curse on' },
    discussion: { fa: 'بحث', en: 'Discussion' },
    voting: { fa: 'رأی‌گیری', en: 'Voting' },
    startVoting: { fa: 'شروع رأی‌گیری', en: 'Start Voting' },
    backDiscussion: { fa: 'بازگشت به بحث', en: 'Back to Discussion' },
    selectCandidate: { fa: 'انتخاب نامزد رأی', en: 'Select Candidate' },
    votingFor: { fa: 'رأی به', en: 'Voting for' },
    voters: { fa: 'رأی‌دهندگان', en: 'Voters' },
    execute: { fa: 'اعدام', en: 'Execute' },
    executeConfirm: { fa: 'آیا %s اعدام شود؟', en: 'Execute %s?' },
    yes: { fa: 'بله', en: 'Yes' },
    no: { fa: 'خیر', en: 'No' },
    immuneVote: { fa: 'مصونیت از رأی دارد و قابل اعدام نیست', en: 'Has vote immunity and cannot be executed' },
    noonNap: { fa: 'خواب نیم‌روزی', en: 'Noon Nap' },
    shooterSelect: { fa: 'به چه کسی شلیک می‌کند؟', en: 'Who will shoot?' },
    shootTarget: { fa: 'شلیک به', en: 'Shoot at' },
    skipShot: { fa: 'نزدن تیر', en: 'Skip Shot' },
    bombDefuse: { fa: 'رمز بمب را حدس بزنید', en: 'Guess bomb code' },
    bombCode: { fa: 'رمز بمب', en: 'Bomb Code' },
    checkCode: { fa: 'بررسی', en: 'Check' },
    bombDefused: { fa: 'بمب خنثی شد', en: 'Bomb defused' },
    bombExploded: { fa: 'بمب منفجر شد', en: 'Bomb exploded' },
    guardianKilled: { fa: 'محافظ به جای فرد بمب‌شده حذف شد', en: 'Guardian eliminated instead' },
    wrongCode: { fa: 'رمز اشتباه زد و حذف شد', en: 'Wrong code, eliminated' },
