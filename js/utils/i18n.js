...
export const translations = {
  ...
  lastAction: {
    ...
    cards: {
      ...
      5: {
        ...
        desc: { fa: 'یک بازیکن زنده را انتخاب کن — نقش بازیکن حذف‌شده کاملاً به آن بازیکن منتقل می‌شود (شامل سپر، توانایی‌ها و طلسم جک). بازیکن حذف‌شده قابل احیا نیست.', en: 'Choose an alive player — the eliminated player\'s role is fully transferred to them (including shield, abilities, and Jack\'s curse). The eliminated player cannot be revived.' }
      },
    }
  },
  ...
  rulebook: {
    ...
    nightOrder: {
      ...
      body: {
        fa: 'نقش‌ها به ترتیب زیر بیدار و عمل می‌کنند:\n\n🔴 تیم مافیا:\n1. پدرخوانده (شلیک / سلاخی / مذاکره)\n2. دکتر لکتر (هیل مافیا)\n3. بمب‌گذار (کارگذاری بمب)\n4. سایلنسر (سکوت)\n5. جادوگر (بلاک)\n\n🔵 تیم شهروند و مستقل:\n6. خبرنگار (بررسی مذاکره)\n7. دکتر واتسون (هیل)\n8. کارآگاه (استعلام)\n9. همشهری کین (افشا)\n10. اسنایپر (شلیک)\n11. فراماسون (عضوگیری)\n12. کنستانتین (احیا)\n13. تفنگدار (دادن تیر)\n14. جک (طلسم)\n15. زودیاک (شلیک)\n\nترتیب حل اقدامات (ریزالو):\nبلاک جادوگر → هیل واتسون → هیل لکتر → اقدام پدرخوانده → طلسم جک → شلیک زودیاک → شلیک اسنایپر → استعلام کارآگاه → سکوت سایلنسر → بمب‌گذاری → احیای کنستانتین → عضوگیری فراماسون → تیر تفنگدار → افشای کین → زنجیره طلسم جک',
        en: 'Roles wake and act in this order:\n\n🔴 Mafia Team:\n1. Godfather (shoot / salakhi / negotiate)\n2. Dr. Lecter (heal mafia)\n3. Bomber (plant bomb)\n4. Silencer (silence)\n5. Sorcerer (block)\n\n🔵 Citizen & Independent:\n6. Reporter (check negotiation)\n7. Dr. Watson (heal)\n8. Detective (investigate)\n9. Citizen Kane (reveal)\n10. Sniper (shoot)\n11. Freemason (recruit)\n12. Constantine (revive)\n13. Gunner (give bullets)\n14. Jack (curse)\n15. Zodiac (shoot)\n\nResolution order:\nSorcerer block → Watson heal → Lecter heal → Godfather action → Jack curse → Zodiac kill → Sniper shoot → Detective investigate → Silencer silence → Bomb plant → Constantine revive → Freemason recruit → Gunner bullets → Kane reveal → Jack curse chain'
      }
    },
    dayRules: {
