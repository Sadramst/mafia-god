  ...
  lastAction: {
    ...
    cards: {
      ...
      5: {
        ...
        desc: { fa: 'یک بازیکن زنده را انتخاب کن — نقش بازیکن حذف‌شده و بازیکن انتخاب‌شده با هم جابه‌جا می‌شود. وضعیت بازیکن حذف‌شده (مثل طلسم جک روی او) هم به بازیکن انتخاب‌شده منتقل می‌شود. بازیکن حذف‌شده قابل احیا نیست.', en: 'Choose an alive player — the eliminated player and chosen player exchange roles. The eliminated player\'s states (such as Jack\'s curse on them) also move to the chosen player. The eliminated player cannot be revived.' }
      },
    }
  },
