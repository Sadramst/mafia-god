...
export const translations = {
  ...
  history: {
    ...
    handshake_triggered: { fa: '🤝 دست‌دادن سه‌نفره — ۳ نفر باقی مانده‌اند. ۲ دقیقه صحبت آزاد و سپس انتخاب متحد.', en: '🤝 3-Player Handshake — 3 players remain. 2 minutes free talk, then choose your ally.' },
  ...
  rulebook: {
    ...
    overview: {
      ...
      body: {
        fa: 'مافیا یک بازی گروهی بین سه تیم است: مافیا، شهروند و مستقل. بازی توسط یک «خدا» (گرداننده) مدیریت می‌شود.\n\n• تیم مافیا: در تاریکی شب اعضای شهروند و مستقل را حذف می‌کنند.\n• تیم شهروند: تلاش می‌کنند اعضای مافیا و مستقل را شناسایی و حذف کنند.\n• مستقل‌ها: هدف‌های جداگانه خود را دارند.\n\nبازی بین فازهای شب و روز جابجا می‌شود تا یکی از تیم‌ها به شرایط پیروزی برسد.',
        en: 'Mafia is a party game between three teams: Mafia, Citizens, and Independents. The game is managed by a "God" (moderator).\n\n• Mafia Team: Eliminates citizens and independents during the night.\n• Citizen Team: Tries to identify and eliminate mafia and independents.\n• Independents: Have their own separate goals.\n\nThe game alternates between night and day phases until one team meets their victory condition.'
      }
    },
    victory: {
      title: { fa: '🏆 شرایط پیروزی', en: '🏆 Victory Conditions' },
      body: {
        fa: '🔵 پیروزی شهروندان:\nتمام اعضای مافیا و تمام مستقل‌ها (جک و زودیاک) حذف شوند.\n\n🔴 پیروزی مافیا:\nتعداد اعضای زنده مافیا ≥ مجموع شهروندان + مستقل‌ها (مگر اینکه دقیقاً ۳ نفر با یک مستقل باقی باشند → دست‌دادن).\n\n🟣 پیروزی جک (فوری):\nاگر تمام مافیا بمیرند و جک زنده باشد → جک فوراً برنده می‌شود.\n\n🟣 پیروزی زودیاک:\nزودیاک با مرگ مافیا خودکار برنده نمی‌شود. باید کشتن ادامه دهد تا ۳ نفر باقی بمانند، سپس از طریق دست‌دادن برنده شود.\n\n🤝 دست‌دادن سه‌نفره:\nوقتی دقیقاً ۳ نفر باقی بمانند و حداقل یکی مستقل باشد: ۲ دقیقه صحبت آزاد، سپس هر نفر یک نفر را برای دست‌دادن انتخاب می‌کند. دو نفری که دست می‌دهند برنده هستند. اگر مستقل در جفت باشد → مستقل برنده. اگر مافیا+شهروند بدون مستقل → مافیا برنده.',
        en: '🔵 Citizen Victory:\nAll mafia members AND all independents (Jack & Zodiac) are eliminated.\n\n🔴 Mafia Victory:\nAlive mafia count ≥ citizens + independents (unless exactly 3 remain with an independent → handshake).\n\n🟣 Jack Instant Win:\nIf all mafia die while Jack is still alive → Jack wins immediately.\n\n🟣 Zodiac Victory:\nZodiac does NOT auto-win when mafia dies. Must keep killing until 3 players remain, then win through the handshake.\n\n🤝 3-Player Handshake Endgame:\nWhen exactly 3 players remain with at least 1 independent: 2 minutes of free talk, then each player picks who to ally with. The allied pair wins. If an independent is in the pair → independent wins. If mafia+citizen without independent → mafia wins.'
      }
    },
    phases: {
