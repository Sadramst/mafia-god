...
export const translations = {
  ...
  lastAction: {
    ...
    cards: {
      ...
      5: {
        ...
        desc: { fa: 'یک بازیکن زنده را انتخاب کن — نقش بازیکن حذف‌شده و بازیکن انتخاب‌شده با هم جابه‌جا می‌شود. اگر بازیکن حذف‌شده طلسم فعال جک را داشته باشد، جک همان لحظه حذف می‌شود. بازیکن حذف‌شده قابل احیا نیست.', en: 'Choose an alive player — the eliminated player and chosen player exchange roles. If the eliminated player is Jack\'s active cursed target, Jack is eliminated immediately. The eliminated player cannot be revived.' }
      },
    }
  },
  ...
  setup: {
    ...
    zodiacRequiresBodyguard: { fa: 'این نقش نیاز به محافظ دارد — محافظ به‌طور خودکار اضافه شد.', en: 'This role requires Bodyguard — Bodyguard was added automatically.' },
    cannotRemoveBodyguardWhenZodiac: { fa: 'در حالی که زودیاک یا بمب‌گذار انتخاب شده، نمی‌توان محافظ را حذف کرد.', en: 'Cannot remove Bodyguard while Zodiac or Bomber is selected.' },
    bodyguardRequiresZodiacOrBomber: { fa: 'محافظ فقط با زودیاک یا بمب‌گذار قابل انتخاب است.', en: 'Bodyguard can only be selected with Zodiac or Bomber.' },
  ...
  night: {
    ...
    framasonWarning: { fa: '🔺 فراماسون یک نفر را بیدار می‌کند. اگر مافیا (غیر جاسوس) یا مستقل باشد، صبح فردا مرگ فراماسونی — تمام تیم فراماسون حذف می‌شوند! جاسوس امن است.', en: '🔺 Freemason wakes someone. If mafia (not spy) or independent → Freemason death next morning: all team eliminated! Spy joins safely.' },
  ...
  day: {
    ...
    framasonContaminated: { fa: '🔺 مرگ فراماسونی داشتیم!', en: '🔺 We had a Freemason death!' },
    framasonContaminationDesc: { fa: 'فراماسون یک بازیکن مافیا یا مستقل را بیدار کرد — تمام اعضای تیم فراماسون حذف می‌شوند (به جز آن مافیا/مستقل).\n(دکمه «حل فراماسون» در پایین)', en: 'Freemason woke a mafia or independent player — all freemason team members will be eliminated (except the infiltrator).\n(button "Resolve Freemason" below)' },
    ...
    resolveFramason: { fa: '🔺 مرگ فراماسونی — حذف اعضای تیم', en: '🔺 Freemason Death — Eliminate Team Members' },
    startDiscussion: { fa: '💬 شروع بحث روز', en: '💬 Start Day Discussion' },
    framasonEliminated: { fa: '🔺 مرگ فراماسونی: %s حذف شدند', en: '🔺 Freemason death: %s eliminated' },
    ...
    dismiss: { fa: 'متوجه شدم', en: 'Got it' },
    cowboyTitle: { fa: '🤠 کابوی', en: '🤠 Cowboy' },
    cowboyDesc: { fa: 'کابوی می‌تواند اعلام کند و یک نفر را انتخاب کند — آن شخص فوراً حذف می‌شود و خدا سمتش را اعلام می‌کند.', en: 'Cowboy can declare and choose anyone — that person is eliminated immediately and God announces their side.' },
    cowboyDeclare: { fa: '🤠 من کابوی‌ام!', en: '🤠 I am Cowboy!' },
    cowboyChoose: { fa: '🤠 کابوی: کی رو انتخاب می‌کنی؟', en: '🤠 Cowboy: who do you choose?' },
    cowboyConfirm: { fa: '✅ تأیید', en: '✅ Confirm' },
    cowboyResultTitle: { fa: '🤠 نتیجه کابوی', en: '🤠 Cowboy Result' },
    cowboySideMafia: { fa: 'مافیا', en: 'Mafia' },
    cowboySideJack: { fa: 'جک', en: 'Jack' },
    cowboySideZodiac: { fa: 'زودیاک', en: 'Zodiac' },
    cowboySideCitizen: { fa: 'شهروند', en: 'Citizen' },
    cowboyJackSurvived: { fa: 'جک زنده ماند ولی طلسمش برای همیشه قفل شد!', en: 'Jack survived but his curse is permanently locked!' },
    cowboyEliminated: { fa: 'حذف شد.', en: 'eliminated.' },
    cowboySelfEliminated: { fa: 'کابوی هم حذف شد.', en: 'Cowboy is also eliminated.' },
    cowboyJackRole: { fa: 'نقش: %s', en: 'Role: %s' },
    ...
    runoffTie: { fa: 'مساوی — شیر یا خط برای تعیین نتیجه', en: 'Tie — coin flip to decide' },
  ...
  history: {
    ...
    silence: { fa: '🤐 %s توسط سایلنسر سکوت شد.', en: '🤐 %s was silenced by the Silencer.' },
    ...
    framason_contaminated: { fa: '🔺⚠️ فراماسون %s را بیدار کرد — مرگ فراماسونی!', en: '🔺⚠️ Freemason woke %s — Freemason death!' },
    ...
    kane_jack_curse_locked: { fa: '🔒 همشهری کین هویت جک (%s) را فاش کرد — طلسم جک از این پس ثابت شد! اگر طلسم‌شده بمیرد جک هم خارج می‌شود.', en: '🔒 Citizen Kane exposed Jack (%s) — Jack\'s curse is now permanently locked! If the cursed player dies, Jack is eliminated too.' },
    ...
    framason_member_death: { fa: '🔺 %s (مرگ فراماسونی) حذف شد.', en: '🔺 %s eliminated (Freemason death).' },
    ...
    cowboy_kill: { fa: '🤠 %s (کابوی) %s را حذف کرد.', en: '🤠 %s (Cowboy) eliminated %s.' },
    cowboy_jack: { fa: '🤠 %s (کابوی) %s را انتخاب کرد — جک زنده ماند ولی طلسم قفل شد!', en: '🤠 %s (Cowboy) chose %s — Jack survived but curse is locked!' },
    cowboy_self_eliminated: { fa: '🤠 کابوی (%s) حذف شد.', en: '🤠 Cowboy (%s) eliminated.' },
    ...
    lastActionGuessImmune: { fa: '🃏 ذهن زیبا: حدس درست اما %s مصون است — فقط از طریق طلسم حذف می‌شود.', en: '🃏 Beautiful Mind: Correct guess but %s is immune — can only be eliminated through curse chain.' },
    morning_shot_jack_curse_locked: { fa: '🔫 %s هدف تیر قرار گرفت — جک زنده ماند اما طلسم از این پس ثابت است!', en: '🔫 %s was shot — Jack survived but curse is now permanently locked!' },
  ...
  rulebook: {
    ...
    citizenRoles: {
      ...
      body: {
        fa: '⚕️ دکتر واتسون:\nهر شب یک نفر (یا خودش) را هیل می‌کند. هیل دیگران نامحدود، هیل خود محدود (پیش‌فرض ۲). هدف هیل‌شده اگر مورد شلیک قرار بگیرد زنده می‌ماند.\n\n🔍 کارآگاه:\nهر شب یک بازیکن را استعلام می‌کند.\n• مافیا (غیر پدرخوانده) یا مظنون → 👍\n• پدرخوانده، مستقل یا شهروند (غیر مظنون) → 👎\n• بلاک‌شده توسط جادوگر → ✊\n• اگر جوکر همان فرد را هدف گرفته باشد → نتیجه برعکس (👍↔👎)\n\n🎖️ همشهری کین:\nیک‌بار در بازی هدفی را انتخاب می‌کند. اگر هدف تا صبح زنده بماند و مافیا یا مستقل باشد → خدا صبح نقشش را اعلام می‌کند. هدف در بازی می‌ماند. شب بعد خدا کین را حذف می‌کند (کنستانتین می‌تواند احیا کند). اگر هدف همان شب بمیرد → توانایی برمی‌گردد. اگر کین بدون استفاده از توانایی بمیرد و احیا شود → هنوز توانایی دارد. اگر کین جک را افشا کند → طلسم جک ثابت می‌شود و خدا اعلام می‌کند؛ اگر فرد طلسم‌شده بمیرد جک فوراً حذف می‌شود.\n\n🎯 اسنایپر:\nتعداد شلیک محدود (پیش‌فرض ۲).\n• هدف جک یا زودیاک → هیچ اتفاقی نمی‌افتد، تیر مصرف\n• هدف پدرخوانده با سپر → سپر جذب، تیر مصرف\n• هدف مافیا هیل‌شده → تیر مصرف\n• هدف مافیا بدون محافظت → کشته\n• هدف شهروند → اسنایپر خودش حذف می‌شود (کنستانتین می‌تواند اسنایپر را احیا کند)\nیک‌بار سپر دارد.\n\n🔫 تفنگدار:\nهر شب تیر (مشقی یا جنگی) به بازیکنان می‌دهد — حداکثر یک تیر به هر نفر. صبح دارنده شلیک می‌کند. تیر جنگی استفاده‌نشده در شروع رأی‌گیری منفجر می‌شود!\n\n🔺 فراماسون:\nهر شب یک نفر عضو‌گیری. حداکثر ۲ متحد (قابل تنظیم).\n• شهروند یا جاسوس → امن\n• مافیا (غیر جاسوس) یا مستقل → صبح تمام تیم فراماسون حذف (آلودگی)\n\n🛡️ محافظ:\nاقدام شبانه ندارد.\n۱) خواب نیم‌روزی: حدس رمز بمب (درست → خنثی، غلط → محافظ حذف)\n۲) اگر زودیاک به محافظ شلیک → زودیاک حذف، محافظ زنده\n\n📰 خبرنگار:\nبعد از خریداری، یک بار از خدا می‌پرسد آیا موفق بوده. خدا 👍 یا 👎 نشان می‌دهد. نیاز به مذاکره‌کننده دارد.\n\n✝️ کنستانتین:\nیک‌بار در بازی یک مرده را احیا می‌کند. نمی‌تواند قربانیان سلاخی را احیا کند. می‌تواند همشهری کین را احیا کند (حتی بعد از فدای کین).\n\n🤠 کابوی:\nاقدام روزانه (یک‌بار در بازی). اعلام «من کابوی‌ام» و یک نفر را انتخاب → فوراً حذف. خدا سمت دقیق اعلام: مافیا/جک/زودیاک/شهروند. جک زنده می‌ماند ولی طلسم قفل. شهروندان قابل احیا. جادوگر نمی‌تواند بلاک کند.\n\n👤 شهروند ساده:\nبدون توانایی (حداکثر ۱۰).\n\n🔎 مظنون:\nبدون توانایی. تفاوت: در استعلام کارآگاه مافیا نشان داده می‌شود (مثبت کاذب). قابل خریداری توسط مذاکره‌کننده.',
        en: '⚕️ Dr. Watson:\nEach night heals one person (or self). Unlimited heals on others, limited self-heal (default 2). Healed target survives one lethal shot.\n\n🔍 Detective:\nEach night investigates one player.\n• Mafia (not Godfather) or Suspect → 👍\n• Godfather, independent, or citizen (not Suspect) → 👎\n• Blocked by Sorcerer → ✊\n• If Joker targeted the same player → result is reversed (👍↔👎)\n\n🎖️ Citizen Kane:\nOnce per game, selects a target. If target survives until morning and is mafia or independent → God announces role. Target stays in game. Next night God eliminates Kane (Constantine CAN revive). If target dies same night → ability returns. If Kane dies without using ability and is revived → still has ability. If Kane reveals Jack → Jack\'s curse is permanently locked and God announces it; if the cursed player dies, Jack is immediately eliminated.\n\n🎯 Sniper:\nLimited shots (default 2).\n• Jack or Zodiac target → nothing happens, bullet spent\n• Godfather with shield → shield absorbs, bullet spent\n• Mafia healed by Dr. Lecter → bullet spent\n• Mafia unprotected → killed\n• Citizen target → sniper dies as penalty (Constantine can revive sniper)\nHas one-time shield.\n\n🔫 Gunner:\nEach night gives bullets (blank or live) to players — max one per person. Morning: holder shoots. Unused live bullets explode at voting start!\n\n🔺 Freemason:\nEach night recruits one person. Max 2 allies (configurable).\n• Citizen or Spy → safe\n• Mafia (not spy) or independent → morning: entire freemason team eliminated (contamination)\n\n🛡️ Bodyguard:\nNo night action.\n1) Noon nap: Guesses bomb code (correct → defused, wrong → bodyguard eliminated)\n2) If Zodiac shoots bodyguard → Zodiac dies, bodyguard survives\n\n📰 Reporter:\nAfter negotiation, one chance to ask God if it succeeded. God shows 👍 or 👎. Requires Negotiator.\n\n✝️ Constantine:\nOnce per game, revives one dead player. Cannot revive salakhi victims. CAN revive Citizen Kane (even after Kane sacrifice).\n\n🤠 Cowboy:\nDay action only (once per game). Declares and chooses any player → eliminated immediately. God announces exact side: mafia/Jack/Zodiac/citizen. Jack survives but curse permanently locked. Citizens can be revived by Constantine. Cannot be blocked by Sorcerer (day action).\n\n👤 Simple Citizen:\nNo abilities (up to 10).\n\n🔎 Suspect:\nNo abilities. Difference: Appears as mafia in detective investigation (false positive). Recruitable via negotiation.'
      }
    },
    independentRoles: {
      title: { fa: '🟣 نقش‌های مستقل', en: '🟣 Independent Roles' },
      body: {
        fa: '🔪 جک:\nهر شب روی یک نفر طلسم می‌گذارد. اگر فرد طلسم‌شده کشته شود (شب یا روز) → جک هم حذف می‌شود.\n• با سلاخی صحیح قابل حذف است (هیچ‌کس از سلاخی مصون نیست)\n• مصون از تمام انواع دیگر مرگ (شلیک شبانه، رأی، تیر صبحگاهی، کارت حرکت آخر)\n• نمی‌تواند روی یک نفر دوباره طلسم بگذارد مگر گزینه دیگری نباشد\n• اگر در روز تیر بخورد → زنده می‌ماند ولی طلسم برای همیشه ثابت می‌شود\n• اگر هدف رأی قرار بگیرد → زنده می‌ماند ولی طلسم ثابت می‌شود\n• اگر جادوگر بلاک کند: طلسم قفل می‌شود و جابجا نمی‌شود\n• اگر همشهری کین جک را افشا کند → طلسم ثابت می‌شود و خدا اعلام می‌کند. از آن لحظه اگر فرد طلسم‌شده بمیرد جک فوراً حذف می‌شود\n• 🏆 پیروزی: اگر تمام مافیا بمیرند و جک زنده باشد → جک فوراً برنده! اگر جک به آشوب برسد (۳ نفر) → جک فوراً برنده!\n\n♈ زودیاک:\nقاتل مستقل. شلیک بر اساس تنظیمات (هر شب / فرد / زوج).\n• مصونیت از شلیک شبانه\n• با تیر صبحگاهی جنگی قابل حذف است\n• با رأی روز قابل حذف است\n• اگر به محافظ شلیک کند → زودیاک حذف، محافظ زنده\n• با سلاخی صحیح قابل حذف است\n• 🏆 پیروزی: با مرگ مافیا خودکار برنده نمی‌شود. باید کشتن ادامه دهد تا ۳ نفر باقی بمانند و از طریق آشوب برنده شود.',
        en: '🔪 Jack:\nEach night curses one person. If cursed person is killed (night or day) → Jack is also eliminated.\n• CAN be killed by correct salakhi (no one is immune from salakhi)\n• Immune to all other death types (night shots, votes, morning shots, last action cards)\n• Cannot curse the same person again unless no other option\n• If shot in day → survives but curse is permanently locked\n• If targeted by vote → survives but curse is permanently locked\n• If blocked by Sorcerer: curse is locked and cannot be moved\n• If Citizen Kane reveals Jack → curse is permanently locked and God announces it. From that point, if the cursed player dies, Jack is immediately eliminated\n• 🏆 Victory: If all mafia die and Jack is alive → Jack wins instantly! If Jack reaches Chaos (3 players) → Jack wins immediately!\n\n♈ Zodiac:\nIndependent killer. Shoots based on settings (every night / odd / even).\n• Immune to night shots\n• CAN be killed by live morning bullet (day shoot)\n• Can be voted out during day\n• If shoots Bodyguard → Zodiac dies, bodyguard survives\n• Can be eliminated by correct salakhi\n• 🏆 Victory: Does NOT auto-win when mafia dies. Must keep killing until 3 players remain and win through Chaos.'
      }
    },
    specialMechanics: {
      title: { fa: '⚡ مکانیک‌های ویژه', en: '⚡ Special Mechanics' },
      body: {
        fa: '🗡️ سلاخی:\nپدرخوانده نقش دقیق هدف را حدس می‌زند. درست → حذف بدون محافظت. غلط → هیچی. در شب سلاخی مافیا شلیک ندارد. مرگ غیرقابل احیا. سلاخی می‌تواند جک و زودیاک را حذف کند (هیچ‌کس از سلاخی مصون نیست).\n\n🤝 مذاکره (خریداری):\nوقتی مافیای زنده ≤ آستانه و مذاکره‌کننده زنده باشد. فقط شهروند ساده یا مظنون قابل خریداری. هر نقش دیگر → شکست و از دست رفتن شلیک.\n\n💣 بمب:\nبمب‌گذار یک‌بار بمب با رمز ۱-۴ می‌گذارد. صبح اعلام. در خواب نیم‌روزی: محافظ → فرد بمب‌شده حدس می‌زنند.\n\n🔪 طلسم جک:\nهر شب روی یک نفر (نمی‌تواند تکراری طلسم بگذارد مگر گزینه دیگری نباشد). اگر آن فرد بمیرد → جک هم می‌میرد. بلاک جادوگر → طلسم ثابت. تیر صبحگاهی یا رأی روی جک → طلسم ثابت. افشای جک توسط همشهری کین → طلسم ثابت و خدا اعلام می‌کند. وقتی طلسم ثابت شود دیگر قابل تغییر نیست و اگر فرد طلسم‌شده بمیرد جک فوراً حذف می‌شود.\n\n🛡️ سپر:\nپدرخوانده و اسنایپر هر کدام یک‌بار سپر دارند. یک شلیک شبانه را جذب می‌کند. سلاخی/بمب/رأی/انفجار تیر از سپر رد می‌شوند.\n\n🔺 اتحاد فراماسون:\nهر شب یک عضوگیری. شهروند/جاسوس → امن. مافیا/مستقل → آلودگی (تمام تیم فردا حذف). اگر رهبر بمیرد → اتحاد غیرفعال.\n\n🔫 تیر صبحگاهی:\nتفنگدار شب تیر می‌دهد. صبح دارنده شلیک می‌کند. مشقی = امن. جنگی = کشنده اگر بدون محافظت. جنگی استفاده‌نشده = انفجار در رأی‌گیری. ⚠️ اگر جک تیر بخورد → زنده می‌ماند ولی طلسم ثابت می‌شود. زودیاک با تیر جنگی صبحگاهی حذف می‌شود.\n\n🧙 جادوگر:\nفقط اقدام شبانه را بلاک می‌کند — اقدامات روز (تیر صبحگاهی، کابوی و غیره) تحت تأثیر قرار نمی‌گیرند. طلسم جک بلاک‌شده قفل و ثابت می‌ماند.\n\n🤠 کابوی:\nتیم شهروند، اقدام روزانه (یک‌بار در بازی). اعلام می‌کند و یک نفر را انتخاب می‌کند → فوراً حذف. خدا سمت دقیق اعلام می‌کند: «مافیا» / «جک» / «زودیاک» / «شهروند». جک زنده می‌ماند ولی طلسم قفل می‌شود. شهروندان توسط کنستانتین قابل احیا. جادوگر نمی‌تواند بلاک کند (اقدام روزانه).\n\n🃏 ذهن زیبا:\nاگر جک یا مافیا هدف رأی‌گیری باشد → کارت ذهن زیبا از دسته حذف می‌شود. ذهن زیبا نمی‌تواند جک را حذف کند (جک فقط از طریق طلسم یا سلاخی می‌میرد).\n\n🌀 آشوب:\nوقتی دقیقاً ۳ نفر باقی بمانند و هیچ تیمی برنده نشده باشد: بازی وارد فاز آشوب می‌شود. اگر جک زنده باشد → جک فوراً برنده! در غیر این صورت ۲ دقیقه صحبت آزاد. ۳ نفر تصمیم می‌گیرند یک نفر حذف شود (دو نفر دست می‌دهند). دو نفر باقی‌مانده برنده:\n• شهروند + شهروند → شهروند برنده\n• شهروند + مافیا → مافیا برنده\n• شهروند + مستقل → مستقل برنده\n• مافیا + مستقل → مستقل برنده',
        en: '🗡️ Salakhi:\nGodfather guesses exact role. Correct → eliminated, bypasses all protection. Wrong → nothing. On salakhi night, mafia has no shot. Death NOT revivable. Salakhi CAN kill Jack and Zodiac (no one is immune from salakhi).\n\n🤝 Negotiation:\nWhen alive mafia ≤ threshold and Negotiator alive. Only simple citizen or suspect can be recruited. Any other role → fails, mafia loses shot.\n\n💣 Bomb:\nBomber plants once with code 1-4. Morning: announced. Noon nap: Bodyguard → bombed player guess.\n\n🔪 Jack\'s Curse:\nEach night curses one person (cannot re-curse the same person unless no other option). If that person dies → Jack dies too. Sorcerer block → curse locked. Morning shot or vote on Jack → curse permanently locked. Citizen Kane revealing Jack → curse permanently locked and God announces it. Once locked, the curse cannot be changed — if the cursed player dies, Jack is immediately eliminated.\n\n🛡️ Shield:\nGodfather and Sniper each have one-time shield. Absorbs one night shot. Salakhi/bomb/vote/bullet explosion bypass shield.\n\n🔺 Freemason Alliance:\nEach night recruits one. Citizen/spy → safe. Mafia/independent → contamination (entire team eliminated next morning). If leader dies → alliance inactive.\n\n🔫 Morning Shots:\nGunner gives bullets at night. Morning: holder shoots. Blank = safe. Live = lethal if unprotected. Unused live = explosion at voting. ⚠️ If Jack is shot → survives but curse is permanently locked. Zodiac CAN be killed by a live morning bullet.\n\n🧙 Sorcerer Effect:\nONLY blocks night actions — day actions (morning shots, cowboy ability, etc.) work normally. Blocked Jack\'s curse is locked and preserved.\n\n🤠 Cowboy:\nCitizen team, day action only (once per game). Declares and chooses any player → eliminated immediately. God announces exact side: \"mafia\" / \"Jack\" / \"Zodiac\" / \"citizen\". Jack survives but curse is permanently locked. Citizens can be revived by Constantine. Cannot be blocked by Sorcerer (day action).\n\n🃏 Beautiful Mind:\nIf Jack or mafia is the vote target → Beautiful Mind is auto-discarded from the deck. Beautiful Mind CANNOT kill Jack (Jack only dies through curse chain or salakhi).\n\n🌀 Chaos:\nWhen exactly 3 players remain and no team has won: game enters Chaos phase. If Jack is alive → Jack wins immediately! Otherwise 2 minutes of free talk. The 3 players decide to eliminate one (two shake hands). The remaining pair wins:\n• Citizen + Citizen → Citizens win\n• Citizen + Mafia → Mafia wins\n• Citizen + Independent → Independent wins\n• Mafia + Independent → Independent wins'
      }
    },
    lastActionCards: {
      title: { fa: '🃏 کارت‌های حرکت آخر', en: '🃏 Last Action Cards' },
      body: {
        fa: 'وقتی بازیکنی با رأی حذف می‌شود، عدد ۱ تا تعداد کارت‌های باقیمانده را انتخاب می‌کند و یک کارت تصادفی می‌کشد. در هر بازی ۵ کارت وجود دارد و هر کارت فقط یک بار استفاده می‌شود.\n\n1️⃣ شلیک نهایی:\nبازیکن حذف‌شده فوراً یک بازیکن زنده را انتخاب و شلیک می‌کند. اگر هدف مصون از شلیک باشد بی‌اثر است. شب بعد مافیا نمی‌تواند شلیک کند.\n\n2️⃣ بی‌خوابی:\nشب بعد کاملاً حذف می‌شود — هیچ اقدام شبانه‌ای انجام نمی‌شود و مستقیم به روز بعد می‌رویم.\n\n3️⃣ افشای هویت:\nخدا نقش واقعی بازیکن حذف‌شده را به همه اعلام می‌کند. این بازیکن دیگر قابل احیا نیست.\n\n4️⃣ ذهن زیبا:\nبازیکن حذف‌شده یک بازیکن زنده را انتخاب و حدس می‌زند آیا مستقل (جک/زودیاک) است. اگر درست باشد آن بازیکن حذف می‌شود و بازیکن اخراجی به بازی برمی‌گردد!\n\n5️⃣ تغییر چهره:\nبازیکن حذف‌شده یک بازیکن زنده را انتخاب می‌کند — دو نفر نقش عوض می‌کنند. اگر بازیکن حذف‌شده طلسم فعال جک را داشته باشد، جک همان لحظه حذف می‌شود. بازیکن حذف‌شده قابل احیا نیست.',
        en: 'When a player is eliminated by vote, they choose a number from 1 to the number of remaining cards and draw a random card. Each game has 5 cards and each card can only be used once.\n\n1️⃣ Final Shoot:\nThe eliminated player immediately chooses an alive player and shoots them. No effect if the target is shoot-immune. Mafia loses their shot the following night.\n\n2️⃣ Insomnia:\nThe next night is completely skipped — no night actions occur and the game goes directly to the next day.\n\n3️⃣ Reveal Identity:\nGod announces the eliminated player\'s true role to everyone. This player can no longer be revived.\n\n4️⃣ Beautiful Mind:\nThe eliminated player chooses an alive player and guesses if they are independent (Jack/Zodiac). If correct, that player is eliminated and the voted-out player is revived!\n\n5️⃣ Face Off:\nThe eliminated player chooses an alive player — the two players exchange roles. If the eliminated player is Jack\'s active cursed target, Jack is eliminated immediately. The eliminated player cannot be revived.'
      }
    },
    setupRules: {
