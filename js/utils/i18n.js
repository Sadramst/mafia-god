...
export const translations = {
  ...
  history: {
    ...
    sniper_citizen_kill: { fa: '🎯 اسنایپر به %s (شهروند) شلیک کرد — شهروند فوراً حذف شد!', en: '🎯 Sniper shot %s (citizen) — citizen eliminated immediately!' },
