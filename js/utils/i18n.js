...
export const translations = {
  ...
  rulebook: {
    ...
    victory: {
      ...
      body: {
        fa: '🔵 پیروزی شهروندان:\nتمام اعضای مافیا (پدرخوانده و همه همراهانش) و تمام مستقل‌ها (جک و زودیاک) حذف شوند.\n\n🔴 پیروزی مافیا:\nتعداد اعضای زنده مافیا برابر یا بیشتر از مجموع شهروندان و مستقل‌ها باشد.\n\n🟣 پیروزی مستقل:\nفقط در شرایط خاص: حداقل یک مستقل زنده، تمام مافیا مرده، و ۲ نفر یا کمتر در بازی مانده باشند.',
        en: '🔵 Citizen Victory:\nAll mafia members (Godfather and all associates) AND all independents (Jack & Zodiac) are eliminated.\n\n🔴 Mafia Victory:\nAlive mafia count is greater than or equal to the total of alive citizens plus independents.\n\n🟣 Independent Victory:\nRare case: at least 1 independent alive, all mafia dead, and 2 or fewer total players remaining.'
      }
    },
    phases: {
